    ...
    return (
      <>
            ...
            <div className="xSelect">
              ...
              <div className="xSelect">
                <img
                  ...
                  onClick={this.handleXIconClick}
                />
                <span>
                  <img src={this.state.xIcon} alt="X Icon" className="iconSelect" />
                </span>
                <img
                  src={GreaterThan}
                  alt="increase"
            ...
            <div className="oSelect">
              ...
              <div className="oSelect">
                <img
                  ...
                  alt="decrease"
                  className="selectorLeft"
                  onClick={this.handleOIconClick}
                />
                <span>
                  <img src={this.state.oIcon} alt="O Icon" className="iconSelect" />
                </span>
                <img
                  src={GreaterThan}
                  alt="increase"
            ...
            <div className="turnTimer">
              ...
              <div className="turnTimerDiv">
                <img
                  ...
                  alt="decrease"
                  className="selectorLeft"
                  onClick={this.handleTimerDecrease}
                />
                ...
                <img
                  ...
                  alt="increase"
                  className="selectorRight"
                  onClick={this.handleTimerIncrease}
                />
              </div>
            </div>
        ...
        <div className="setButtons">
          <button className="button" onClick={this.applyTrigger}>
            Apply
          </button>
          <button className="button" onClick={this.props.handleSettingsClick}>
            Cancel
          </button>
        </div>
      </>
